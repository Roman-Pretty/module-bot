    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('demonstrators', models.ManyToManyField(blank=True, related_name='demonstrated_modules', to=settings.AUTH_USER_MODEL)),
                ('organizers', models.ManyToManyField(blank=True, related_name='organized_modules', to=settings.AUTH_USER_MODEL)),
